"""
Django settings for my_websites project.
...
WSGI_APPLICATION = "my_websites.wsgi.application"
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('NAME', 'django_server'),              # Nazwa Twojej bazy danych
...
MEDIA_ROOT = BASE_DIR / "imagefiles"
...
# Konfiguracja Groq AI API
# Wymagany klucz API Groq - ustaw w pliku .env
# Groq jest szybszy i tańszy niż OpenAI
