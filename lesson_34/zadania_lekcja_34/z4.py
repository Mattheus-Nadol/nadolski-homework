...
3. W interfejsie GraphiQL wpisz zapytanie:
...
4. Kliknij przycisk "Play" (▶️) aby wykonać zapytanie.

5. Powinieneś zobaczyć dane użytkownika o ID 1 w odpowiedzi.

Możesz zmieniać wartość `id` w zapytaniu, aby pobrać dane innych użytkowników.
"""