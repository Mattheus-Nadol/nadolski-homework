...
# Uwaga:
# Model Book zawiera teraz zagnieżdżony model Author.
# Oznacza to, że w JSON wysyłamy obiekt w obiekcie (author jako osobna struktura).
#
# FastAPI korzysta z Pydantic do walidacji danych wejściowych.
# Pydantic automatycznie:
# - sprawdzi czy wszystkie wymagane pola istnieją,
# - zweryfikuje typy danych (np. price jako float),
# - sprawdzi poprawność emaila (EmailStr w modelu Author),
# - zwaliduje również dane zagnieżdżone.
#
# Jeśli coś będzie niepoprawne (np. brak pola author.email
# lub niepoprawny format emaila), FastAPI zwróci automatycznie
# błąd 422 Unprocessable Entity – bez potrzeby pisania
# dodatkowej logiki walidacyjnej.
